...
<html>
  ...
  <body>
  <div id="loginForm" class="modal show" tabindex="-1" role="dialog" aria-hidden="true">
    ...
    <div class="modal-content">
      ...
      <div id="signinForm" style="display: none !important;">
      <div id="signinForm" class="modal show" tabindex="-1" role="dialog" aria-hidden="true">
        <div class="modal-dialog">
        <div class="modal-content">
          <div class="modal-header">
            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
